...
app.get('/blockchain/assets/samples/:V5CID' , function(req,res,next)
{
...
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/samples/:V5CID/owner' , function(req,res,next)
{
    sample.owner.read(req,res,next,usersToSecurityContext);
});

app.put('/blockchain/assets/samples/:V5CID/owner' , function(req,res,next)
{
...
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/samples/:V5CID/BIN' , function(req,res,next)
{
    sample.BIN.read(req,res,next,usersToSecurityContext);
});

app.put('/blockchain/assets/samples/:V5CID/BIN' , function(req,res,next)
{
...
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/samples/:V5CID/name' , function(req,res,next)
{
    sample.name.read(req,res,next,usersToSecurityContext);
});

app.put('/blockchain/assets/samples/:V5CID/name' , function(req,res,next)
{
...
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/samples/:V5CID/type' , function(req,res,next)
{
    sample.type.read(req,res,next,usersToSecurityContext);
});

app.put('/blockchain/assets/samples/:V5CID/type' , function(req,res,next)
{
...
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/samples/:V5CID/hiv' , function(req,res,next)
{
    sample.HIV.read(req,res,next,usersToSecurityContext);
});

app.put('/blockchain/assets/samples/:V5CID/hiv' , function(req,res,next)
{
...
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/samples/:V5CID/date' , function(req,res,next)
{
    sample.date.read(req,res,next,usersToSecurityContext);
});

app.put('/blockchain/assets/samples/:V5CID/date' , function(req,res,next)
{
...
//-----------------------------------------------------------------------------------------------
app.delete('/blockchain/assets/samples/:V5CID' , function(req,res,next)
{
    sample.delete(req,res,next,usersToSecurityContext);
});

app.get('/blockchain/assets/samples/:V5CID/consume' , function(req,res,next)
{
